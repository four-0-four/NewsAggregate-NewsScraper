...
async def insert_news(conn_params, title: str, description: str, content: str, publishedDate: datetime) -> None:
    # Default values for language_id, isInternal, and isPublished are set directly in the SQL query
    insert_query = """
    INSERT INTO news (title, description, content, publishedDate, language_id, isInternal, ProcessedForIdentity, updatedAt)
    VALUES (%s, %s, %s, %s, 16, 0, 1, null);
    """
